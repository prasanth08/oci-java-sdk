...
public class ApiGatewayWaiters {
    ...
    public ApiGatewayWaiters(
            java.util.concurrent.ExecutorService executorService, ApiGateway client) {
    ...
    public com.oracle.bmc.waiter.Waiter<GetCertificateRequest, GetCertificateResponse>
            forCertificate(
                    ...
                    com.oracle.bmc.apigateway.model.Certificate.LifecycleState... targetStates) {
        com.oracle.bmc.util.internal.Validate.notEmpty(
                targetStates, "At least one targetState must be provided");
        com.oracle.bmc.util.internal.Validate.noNullElements(
                targetStates, "Null targetState values are not permitted");
    ...
    public com.oracle.bmc.waiter.Waiter<GetCertificateRequest, GetCertificateResponse>
            forCertificate(
                    GetCertificateRequest request,
                    com.oracle.bmc.apigateway.model.Certificate.LifecycleState targetState,
                    com.oracle.bmc.waiter.TerminationStrategy terminationStrategy,
                    com.oracle.bmc.waiter.DelayStrategy delayStrategy) {
        com.oracle.bmc.util.internal.Validate.notNull(
                targetState, "The targetState cannot be null");
    ...
    private com.oracle.bmc.waiter.Waiter<GetCertificateRequest, GetCertificateResponse>
            forCertificate(
                    ...
                    final com.oracle.bmc.apigateway.model.Certificate.LifecycleState...
                            targetStates) {
        final java.util.Set<com.oracle.bmc.apigateway.model.Certificate.LifecycleState>
     ...
     * @return a new {@code Waiter} instance
     */
    public com.oracle.bmc.waiter.Waiter<GetSdkRequest, GetSdkResponse> forSdk(
            GetSdkRequest request,
            com.oracle.bmc.apigateway.model.Sdk.LifecycleState... targetStates) {
        com.oracle.bmc.util.internal.Validate.notEmpty(
                targetStates, "At least one targetState must be provided");
        com.oracle.bmc.util.internal.Validate.noNullElements(
                targetStates, "Null targetState values are not permitted");

        return forSdk(com.oracle.bmc.waiter.Waiters.DEFAULT_POLLING_WAITER, request, targetStates);
    }
    ...
    public com.oracle.bmc.waiter.Waiter<GetSdkRequest, GetSdkResponse> forSdk(
            GetSdkRequest request,
            com.oracle.bmc.apigateway.model.Sdk.LifecycleState targetState,
            com.oracle.bmc.waiter.TerminationStrategy terminationStrategy,
            com.oracle.bmc.waiter.DelayStrategy delayStrategy) {
        com.oracle.bmc.util.internal.Validate.notNull(
                targetState, "The targetState cannot be null");
    ...
    // Helper method to create a new Waiter for Sdk.
    private com.oracle.bmc.waiter.Waiter<GetSdkRequest, GetSdkResponse> forSdk(
            com.oracle.bmc.waiter.BmcGenericWaiter waiter,
            final GetSdkRequest request,
            final com.oracle.bmc.apigateway.model.Sdk.LifecycleState... targetStates) {
        final java.util.Set<com.oracle.bmc.apigateway.model.Sdk.LifecycleState> targetStatesSet =
                new java.util.HashSet<>(java.util.Arrays.asList(targetStates));
