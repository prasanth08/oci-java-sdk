...
public class AnomalyDetectionWaiters {
    ...
    public AnomalyDetectionWaiters(
            java.util.concurrent.ExecutorService executorService, AnomalyDetection client) {
     ...
     */
    public com.oracle.bmc.waiter.Waiter<GetAiPrivateEndpointRequest, GetAiPrivateEndpointResponse>
            forAiPrivateEndpoint(
    ...
    // Helper method to create a new Waiter for AiPrivateEndpoint.
    private com.oracle.bmc.waiter.Waiter<GetAiPrivateEndpointRequest, GetAiPrivateEndpointResponse>
            forAiPrivateEndpoint(
                    com.oracle.bmc.waiter.BmcGenericWaiter waiter,
                    final GetAiPrivateEndpointRequest request,
                    final com.oracle.bmc.aianomalydetection.model.AiPrivateEndpoint.LifecycleState
                                    ...
                            targetStates) {
        final java.util.Set<
                        com.oracle.bmc.aianomalydetection.model.AiPrivateEndpoint.LifecycleState>
    ...
    public com.oracle.bmc.waiter.Waiter<GetDataAssetRequest, GetDataAssetResponse> forDataAsset(
            ...
            com.oracle.bmc.aianomalydetection.model.DataAsset.LifecycleState... targetStates) {
        com.oracle.bmc.util.internal.Validate.notEmpty(
                targetStates, "At least one targetState must be provided");
        com.oracle.bmc.util.internal.Validate.noNullElements(
                targetStates, "Null targetState values are not permitted");
    ...
    public com.oracle.bmc.waiter.Waiter<GetDataAssetRequest, GetDataAssetResponse> forDataAsset(
            GetDataAssetRequest request,
            com.oracle.bmc.aianomalydetection.model.DataAsset.LifecycleState targetState,
            com.oracle.bmc.waiter.TerminationStrategy terminationStrategy,
            com.oracle.bmc.waiter.DelayStrategy delayStrategy) {
        com.oracle.bmc.util.internal.Validate.notNull(
                targetState, "The targetState cannot be null");
    ...
    private com.oracle.bmc.waiter.Waiter<GetDataAssetRequest, GetDataAssetResponse> forDataAsset(
            ...
            final com.oracle.bmc.aianomalydetection.model.DataAsset.LifecycleState...
                    targetStates) {
        final java.util.Set<com.oracle.bmc.aianomalydetection.model.DataAsset.LifecycleState>
                targetStatesSet = new java.util.HashSet<>(java.util.Arrays.asList(targetStates));
     ...
     * @return a new {@code Waiter} instance
     */
    public com.oracle.bmc.waiter.Waiter<GetDetectAnomalyJobRequest, GetDetectAnomalyJobResponse>
            forDetectAnomalyJob(
    ...
    // Helper method to create a new Waiter for DetectAnomalyJob.
    private com.oracle.bmc.waiter.Waiter<GetDetectAnomalyJobRequest, GetDetectAnomalyJobResponse>
            forDetectAnomalyJob(
                    com.oracle.bmc.waiter.BmcGenericWaiter waiter,
                    final GetDetectAnomalyJobRequest request,
                    final com.oracle.bmc.aianomalydetection.model.DetectAnomalyJob.LifecycleState...
                            targetStates) {
        final java.util.Set<com.oracle.bmc.aianomalydetection.model.DetectAnomalyJob.LifecycleState>
                targetStatesSet = new java.util.HashSet<>(java.util.Arrays.asList(targetStates));
    ...
    public com.oracle.bmc.waiter.Waiter<GetModelRequest, GetModelResponse> forModel(
            ...
            com.oracle.bmc.aianomalydetection.model.Model.LifecycleState... targetStates) {
        com.oracle.bmc.util.internal.Validate.notEmpty(
                targetStates, "At least one targetState must be provided");
        com.oracle.bmc.util.internal.Validate.noNullElements(
                targetStates, "Null targetState values are not permitted");
    ...
    public com.oracle.bmc.waiter.Waiter<GetModelRequest, GetModelResponse> forModel(
            GetModelRequest request,
            com.oracle.bmc.aianomalydetection.model.Model.LifecycleState targetState,
            com.oracle.bmc.waiter.TerminationStrategy terminationStrategy,
            com.oracle.bmc.waiter.DelayStrategy delayStrategy) {
        com.oracle.bmc.util.internal.Validate.notNull(
                targetState, "The targetState cannot be null");
    ...
    private com.oracle.bmc.waiter.Waiter<GetModelRequest, GetModelResponse> forModel(
            ...
            final com.oracle.bmc.aianomalydetection.model.Model.LifecycleState... targetStates) {
        final java.util.Set<com.oracle.bmc.aianomalydetection.model.Model.LifecycleState>
                targetStatesSet = new java.util.HashSet<>(java.util.Arrays.asList(targetStates));
    ...
    public com.oracle.bmc.waiter.Waiter<GetProjectRequest, GetProjectResponse> forProject(
            ...
            com.oracle.bmc.aianomalydetection.model.Project.LifecycleState... targetStates) {
        com.oracle.bmc.util.internal.Validate.notEmpty(
                targetStates, "At least one targetState must be provided");
        com.oracle.bmc.util.internal.Validate.noNullElements(
                targetStates, "Null targetState values are not permitted");
    ...
    public com.oracle.bmc.waiter.Waiter<GetProjectRequest, GetProjectResponse> forProject(
            GetProjectRequest request,
            com.oracle.bmc.aianomalydetection.model.Project.LifecycleState targetState,
            com.oracle.bmc.waiter.TerminationStrategy terminationStrategy,
            com.oracle.bmc.waiter.DelayStrategy delayStrategy) {
        com.oracle.bmc.util.internal.Validate.notNull(
                targetState, "The targetState cannot be null");
    ...
    private com.oracle.bmc.waiter.Waiter<GetProjectRequest, GetProjectResponse> forProject(
            ...
            final com.oracle.bmc.aianomalydetection.model.Project.LifecycleState... targetStates) {
        final java.util.Set<com.oracle.bmc.aianomalydetection.model.Project.LifecycleState>
                targetStatesSet = new java.util.HashSet<>(java.util.Arrays.asList(targetStates));
